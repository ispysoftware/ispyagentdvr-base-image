...
rm -vrf /etc/apt/sources.list.d/jellyfin.sources /etc/apt/sources.list.d/sid.sources /etc/apt/sources.list.d/backports.sources
rm -vrf /etc/apt/apt.conf.d/99jellyfin-allow-unsigned
